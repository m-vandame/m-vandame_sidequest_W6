...
function preload() {
  ...
  attackSound = loadSound("assets/audio/attack.mp3");
  collectSound = loadSound("assets/audio/collect.mp3");
  hitSound = loadSound("assets/audio/hit.mp3");
  jumpSound = loadSound("assets/audio/jump.mp3");
  fireHitSound = loadSound("assets/audio/firehit.mp3");
}
...
function setup() {
  ...
  // Play background music on loop with medium volume
